...
if (!empty($_POST)) {
    ...
    $sql = "UPDATE `students` SET `surname` = '$surname', `name` = '$name', `patronymic` = '$patronymic', `date_birthday` = '$date_birthday', 
    `home_adress` = '$home_adress', `telephone` = '$telephone', `email` = '$email', `place_of_sw` = '$place_of_sw' WHERE `students`.`id_student` = '$id'";
